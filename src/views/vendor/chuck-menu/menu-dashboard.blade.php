...
<link href="{{asset('chuckbe/chuckcms/vendor/chuck-menu/style.css')}}" rel="stylesheet">
<div id="hwpwrap">
						...
						<div class="wrap">
							...
							<div class="manage-menus">
								<form method="get" action="{{ $currentUrl }}">
									<label for="menu" class="selected-menu">Selecteer het menu dat je wil bewerken:</label>

									{!! ChuckMenu::select('menu', $menulist) !!}

									<span class="submit-btn">
										<input type="submit" class="button-secondary" value="Selecteer">
									</span>
									<span class="add-new-menu-action"> of <a href="{{ $currentUrl }}?action=edit&menu=0">Maak nieuw menu</a>. </span>
								</form>
							</div>
														...
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
																...
																<p class="button-controls">
																	...
																	<a  href="#" onclick="addcustommenu()"  class="button-secondary submit-add-to-menu right"  >Voeg menu item toe</a>
