<li class="card shadow my-3 d-none">
	<div class="card-body d-flex">
		<a class="visitor-log-visitor-profile-link visitorLogTooltip">
			<i class="fa fa-id-card" aria-hidden="true"></i>
			<span>View visitor profile</span>
		</a>
		<div class="col-4 s12 m3">
			<strong class="visitor-log-datetime visitorLogTooltip" title="This visitor's last visit was 2 days ago."> Wednesday, January 19, 2022 - 14:22:32 </strong>
			...
			<div class="visitorreferencearea">
				...
				<div class="visitorReferrer direct d-none">Direct Entry</div>
				<div class="visitorReferrer website d-none">
					<span>Website: </span>
					<a 
						href="#" 
				...
				<span class="visitorDetails">
					...
					<span class="visitorLogIconWithDetails flag" profile-header-text="">
						...
						<ul class="details">
							...
							<li>Region: null</li>
							<li>City: Evere</li>
							<li>Browser language: Language code nl-nl</li>
							<li>IP: 94.111.16.188</li>
							<li>Visitor ID: 29cdbf33762332cb</li>
						</ul>
					</span>
					...
					<span class="visitorLogIconWithDetails resolution" profile-header-text="1536x864">
						...
						<ul class="details">
							...
							<li>Resolution: 1536x864</li>
						</ul>
					</span>
				</span>
			</span>
		</div>
		<div id="visitorActions" class="col-6 s12 m7 column visitorActions">
			<strong>3 Actions - 12s</strong>
			<div class="visitor-log-page-list">
				<ol class="visitorLog actionList d-none">
