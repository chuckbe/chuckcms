...
@section('scripts')
	<script>
      ...
      $('body').on('click', '.field_row_container .well .repeater_well_moveUp_btn', function(e){
        e.stopPropagation();
      ...
      $('body').on('click', '.field_row_container .well .repeater_well_moveDown_btn', function(e){
        e.stopPropagation();
        let el = $(this).closest('.field_row_container');
        let next = el.next();
