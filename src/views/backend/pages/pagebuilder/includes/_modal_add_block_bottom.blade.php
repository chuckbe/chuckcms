          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h4 class="panel-title">
                <a data-toggle="collapse" href="#bottom_{{ $bKey }}" style="text-transform:capitalize">{{ str_replace('-', ' ', $bKey) }}</a>
              </h4>
            </div>
            <div id="bottom_{{ $bKey }}" class="panel-collapse collapse">
              <div class="panel-body">
                <div class="col-sm-12">
                  @foreach($bValue as $block)
                  
                  <div class="col-sm-3">
                    <a class="pb_add_block_bottom_button" data-location="{{ $block['location'] }}" data-name="{{ $block['name'] }}">
