              ...
              <div class="row column-seperation">
                <div class="col-lg-12">
                      <div class="form-group form-group-default required ">
                        <label>Titel</label>
                        <input type="text" class="form-control" placeholder="Titel" id="page_title" name="page_title"  required>
                      </div>
                      <div class="form-group form-group-default required ">
                        <label>Slug</label>
                        <input type="text" class="form-control" placeholder="Titel" id="page_slug" name="slug" required disabled>
              ...
              <div class="row">
                <div class="col-lg-12">
                      <div class="form-group form-group-default required ">
                        ...
                        <input type="text" class="form-control" placeholder="Meta Titel" id="meta_title" name="meta_title" required>
                      </div>
                      <div class="form-group form-group-default required ">
                        <label>Meta Beschrijving</label>
                        <textarea id="meta_description" name="meta_description" placeholder="Meta Beschrijving" style="height:105px;" class="form-control" required></textarea>
                      </div>
                      <div class="form-group form-group-default required ">
                        <label>Meta Sleutelwoorden</label>
                        <textarea id="meta_keywords" name="meta_keywords" placeholder="Meta Sleutelwoorden" style="height:105px;" class="form-control" required></textarea>
                      </div>
                </div>
              </div>
            </div>
