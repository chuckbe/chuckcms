              ...
              <div class="col-sm-12 tab-pane fade show @if($loop->iteration == 1) active @endif tab_page_wrapper" role="tabpanel" id="tab_resource_{{ $langKey }}">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <div class="form-group form-group-default required ">
                                ...
                                <input type="text" class="form-control meta_value @if($seo_field['name'] == 'title') meta_title @endif  @if($seo_field['name'] == 'description') meta_description @endif" placeholder="waarde" id="meta_value" name="meta_{{$seo_field['name']}}[{{ $langKey }}][]" data-order="{{ $loop->iteration }}" value="@if($seo_field['name'] == 'robots' || $seo_field['name'] == 'googlebots') noindex, nofollow @endif" data-lang="{{ $langKey }}" required>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div class="row">
                  <div class="col-lg-4">
                      <div class="form-group form-group-default required ">
                        <label>Meta Key</label>
                        <input type="text" class="form-control meta_key" placeholder="key" id="meta_key_new" name="meta_key[{{ $langKey }}][]" >
                      </div>
                  </div>
                  <div class="col-lg-5">
                      <div class="form-group form-group-default required ">
                          <label>Meta Waarde</label>
                          <input type="text" class="form-control meta_value" placeholder="waarde" id="meta_value_new" name="meta_value[{{ $langKey }}][]" data-lang="{{ $langKey }}">
                      </div>
                  </div>
