...
<html>
  ...
  <body class="fixed-header menu-pin">
    @include('chuckcms::templates.' . $template->slug . '.includes.sidebar')
    <!-- START PAGE-CONTAINER -->
    <div class="page-container ">
      @include('chuckcms::templates.' . $template->slug . '.includes.top')
    ...
    <!-- END PAGE CONTAINER -->
    @include('chuckcms::templates.' . $template->slug . '.includes.quickview')
    <!-- START OVERLAY -->
