        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="widget clearfix widget-contact-us" style="background-image: url({{ URL::to('/') }}'/chuckbe/chuckcms/chuckv2/images/world-map-dark.png'); background-position: 50% 20px; background-repeat: no-repeat">
                        <h4>About POLO</h4>
                        <ul class="list-icon">
