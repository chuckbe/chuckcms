...
<header id="header" class="header-transparent">
    <div id="header-wrap">
        <div class="container">
            <!--Logo-->
            <div id="logo">
                <a href="index.html" class="logo" data-dark-logo="{{ URL::to('/') }}/chuckbe/chuckcms/chuckv2/homepages/branding/images/logo-dark.png">
                    <img src="{{ URL::to('/') }}/chuckbe/chuckcms/chuckv2/homepages/branding/images/logo.png" alt="Polo Logo">
                </a>
            </div>
            <!--End: Logo-->
